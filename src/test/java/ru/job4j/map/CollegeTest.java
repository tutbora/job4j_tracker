...
public class CollegeTest {
    ...
    public void whenAccountIsOptionalEmpty() {
        ...
        assertThat(college.findByAccountOpti("000010"), is(Optional.empty()));
    }
    ...
    public void whenAccountIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        assertThat(college.findByAccountOpti("000001").get().getGroup(), is("201-18-15"));
    }
    ...
    public void whenSubjectIsOptionalEmptyWithNotFoundAccount() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectNameOpti("000010", "Sociology"), is(Optional.empty()));
    }
    ...
    public void whenSubjectIsOptionalEmptyWithFoundAccount() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectNameOpti("000001", "Sociology"), is(Optional.empty()));
    }
    ...
    public void whenSubjectIsOptionalNotEmpty() {
        ...
        College college = new College(students);
        assertThat(college.findBySubjectNameOpti("000002", "Sociology").get().getScore(), is(65));
    }
}